        ...
        return(
            <div>
                <main>
                                        ...
                                        <div className="hero-cap">
                                            ...
                                            <nav aria-label="breadcrumb ">
                                                <ol className="breadcrumb">
                                                    ...
                                                    <li className="breadcrumb-item"><Link to={'/about'}>About me</Link></li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-5 col-md-6">
                                    <div className="about-me-caption">
                                        ...
                                        <p className="pb-30">Unlimited rewards. enjoy attractive discounts flexible
                                            Payme options global usage. Unlimited rewards. enjoy attracti exible ayment
                                            options global usage.</p>
                                        <h5>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.</h5>
                                        <p>Unlimited rewards. enjoy attractive discounts flexible Payme options global
                                            usage. Unlimited rewards. enjoy attracti exible ayment options global
                                            usage.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row ">
                                <div className="col-lg-5">
                                    <div className="about-caption mb-50">
                                        ...
                                        <p className="pera1">Consectetur adipiscing elit, sed do eiusmod tempor ididunt
                                            ut labore et dolore magna aliqua. Quis ipsum suspendisces gravida. Risus
                                            commodo viverra sebfd dho eiusmod tempor maecenas accumsan lacus.</p>
                                        <p>Consectetur adipiscing elit, sed do eiusmod tempor ididunt ut labore et
                                        ...
                                        <div className="col-xl-4">
                                            <div className="blog-wrapper">
                                                <div className="blog-inner">
                                                    ...
                                                    <p>Consectetur adipisicing elit, seddosdoe eiusmod tempor incididunt
                    ...
                    <div className="contact-info-area w-padding2 bg-info" data-background="assets/img/gallery/section_bg04.jpg">
                        <div className="container">
