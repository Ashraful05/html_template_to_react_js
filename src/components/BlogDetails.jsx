                                        ...
                                        <div className="hero-cap">
                                            ...
                                            <nav aria-label="breadcrumb ">
                                                <ol className="breadcrumb">
                                                    ...
                                                    <li className="breadcrumb-item"><Link to={'/blog_details'}>Blog Details</Link></li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-8 posts-list">
                                    <div className="single-post">
                                        ...
                                        <div className="blog_details">
                                            ...
                                            <p>
                                                ...
                                                should have to spend money on boot camp when you can get the MCSE study
                                                materials yourself at a
                                                fraction of the camp price. However, who has the willpower to actually
                                                sit through a
                                                    ...
                                                    <div className="desc">
                                                        ...
                                                        <div className="d-flex justify-content-between">
                                                            ...
                                                            <div className="reply-btn">
                                                                <a href="#"
                                                                   className="btn-reply text-uppercase">reply</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                 ...
                                 <textarea className="form-control w-100" name="comment" id="comment" cols="30" rows="9"
                                           placeholder="Write Comment"></textarea>
                                            ...
                                            <div className="form-group">
                                                <button type="submit"
                                                        className="button button-contactForm btn_1 boxed-btn">Send
                                                    Message
                                                </button>
                                            </div>
                                        </form>
